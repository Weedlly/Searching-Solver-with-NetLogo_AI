...
;          s ->  ifelse( item 0 s = (xcor + sizePath) and item 1 s = ycor and item 4 front < item 4 s)  [
;            set FrontierList replace-item (position s FrontierList) FrontierList front
;          ][]
;        ]
    ...
    [
      ...
      [
;        foreach FrontierList [
;          s ->  ifelse( item 0 s = xcor and item 1 s = (ycor - sizePath) and item 4 front < item 4 s)  [
;            set FrontierList replace-item (position s FrontierList) FrontierList front
;          ][]
;        ]
        let pos_s CheckLocationInFrontier? xcor (ycor - sizePath)
