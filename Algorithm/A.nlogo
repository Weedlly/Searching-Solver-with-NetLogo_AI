...
to setup
  ...
  create-starts 1 [
    ...
    [ stop]
    set FrontierList lput (list xcor ycor 0) FrontierList
...
to A*
  ...
  [
    ...
    set PathList lput (list (first minCostNode) (item 1 minCostNode) (last minCostNode)) PathList ; add front to Pathlist

    let pastCost (last minCostNode)

    setxy (first minCostNode) (item 1 minCostNode) ; move to

    ifelse(CheckLocation? xcor (ycor + sizePath) and  [pcolor] of patch-at-heading-and-distance 0 patchDistance != 9.9999)
    [
      set FrontierList insert-item 0 FrontierList (list xcor (ycor + sizePath) ( pastCost + 1))][]
    ifelse(CheckLocation? (xcor + sizePath) ycor and  [pcolor] of patch-at-heading-and-distance 90 patchDistance != 9.9999)
    [
      set FrontierList insert-item 0 FrontierList (list (xcor + sizePath) ycor ( pastCost + 1))][]
    ifelse(CheckLocation? xcor (ycor - sizePath) and  [pcolor] of patch-at-heading-and-distance 180 patchDistance != 9.9999)
    [
      set FrontierList insert-item 0 FrontierList (list xcor (ycor - sizePath) ( pastCost + 1))][]
    ifelse(CheckLocation? (xcor - sizePath) ycor and [pcolor] of patch-at-heading-and-distance 270 patchDistance != 9.9999)
    [
      set FrontierList insert-item 0 FrontierList (list (xcor - sizePath) ycor ( pastCost + 1))][]
