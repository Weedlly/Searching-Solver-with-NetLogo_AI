...
to setup
  ...
  create-starts 1 [
    ...
    [ stop]
    set FrontierList lput (list xcor ycor xcor ycor) FrontierList
   ]
    create-goals 1 [
    set color red
    set heading 0
...
to BFS
  ...
  [
    ...
    [
      set FrontierList lput (list xcor (ycor + sizePath) xcor ycor) FrontierList

    ] []

    ifelse(CheckLocation? (xcor + sizePath) ycor and  [pcolor] of patch-at-heading-and-distance 90 patchDistance != 9.9999)
    [
      set FrontierList lput (list (xcor + sizePath) ycor xcor ycor) FrontierList
